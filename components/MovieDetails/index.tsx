...
import { saveMovie } from "@/redux/features/moviesDataBaseSlice";
  ...
  return (
    <>
      <motion.article className="w-full bg-blue h-[300px] sm:h-[600px] 2xl:h-[700px] overflow-hidden flex items-center relative">
        ...
        <button
          className="absolute p-5px bottom-0 left-0 shadow-custom-inset bg-blue text-white"
